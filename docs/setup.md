...
3. Install Node.js 10, 11, or 12 (Node.js 13 is currently not supported)
...
3. On a new line at the end of `config.ini`, add `categoryAutomation.newThread = CATEGORY_ID_HERE` (CATEGORY_ID_HERE is your incoming category id)
